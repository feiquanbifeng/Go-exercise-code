...
func Loop7(a map[int]*BigStruct) int {
    return a[2].C30
}

func Loop8(a map[int]string) string {
    return a[2]
}

func Loop9(a []*BigStruct) int {
    switch {
    case a[0].C01 == 3:
        return 0
    case a[1].C01 == 3:
...
func Benchmark_Loop00(b *testing.B) {
    var a = [3]*BigStruct{}
...
func Benchmark_Loop0(b *testing.B) {
    var a = []BigStruct{
        BigStruct{C30: 1},
        BigStruct{C30: 2},
        BigStruct{C30: 3},
...
func Benchmark_Loop8(b *testing.B) {
...
func Benchmark_Loop9(b *testing.B) {
    var a = make([]*BigStruct, 3)
